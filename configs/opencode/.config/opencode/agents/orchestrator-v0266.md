---
description: v0.26.6 — orchestrator variant with bash unrestricted, plan-mode tool-budget ceiling relaxed, and explicit investigation phases. Investigates the codebase directly.
mode: primary
permission:
  question: allow
  task: allow

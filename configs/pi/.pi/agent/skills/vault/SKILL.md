---
name: vault
description: Use the Vault CLI with Focaldata Vaults to list, read, and write KV v2 secrets in the dev and prod environments. Use when managing Focaldata project secrets from the terminal.
---
